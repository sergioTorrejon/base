...
import { UserDto, PaginationDto, SortDto, responseSuccess, RESP_MESSAGES, responseError } from 'src/app/shared';



@Injectable()
export class EstadosDepartamentosService {
  constructor(
    @InjectRepository(EstadosDepartamentos) private readonly repository: Repository<EstadosDepartamentos>,
    ) { }
/************************************************************************************************ */
