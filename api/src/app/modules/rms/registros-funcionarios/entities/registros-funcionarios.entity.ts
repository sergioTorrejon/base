...
import {
  CiudadesMunicipios,
} from 'src/app/modules/catalogos/ciudades_municipios/ciudades_municipios.entity';
import {
  EstadosDepartamentos,
} from 'src/app/modules/catalogos/estados_departamentos/estados_departamentos.entity';
